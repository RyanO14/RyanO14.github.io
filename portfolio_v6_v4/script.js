...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateTimelineSnapState() {
    if (!scrollContainer) return;
    const hasActiveItem = document.querySelector('.timeline-item.active');
    scrollContainer.classList.toggle('timeline-snap-disabled', Boolean(hasActiveItem));
  }
